...
KW.js = KW.javascript = kw(
  ...
  'try', 'catch', 'finally', 'throw', 'true', 'false', 'null', 'undefined', 'void',
  'in', 'of', 'do', 'switch', 'case', 'break', 'continue', 'default', 'extends',
  'super', 'static', 'delete', 'yield', 'get', 'set', 'with', 'debugger',
)
KW.ts = KW.typescript = new Set([
  ...KW.js,
  'interface', 'type', 'enum', 'implements', 'declare', 'abstract', 'readonly',
  'keyof', 'infer', 'never', 'as', 'satisfies', 'namespace', 'override', 'module',
  'asserts', 'is', 'unique', 'accessor',
])
KW.py = KW.python = kw(
  'def', 'class', 'return', 'import', 'from', 'as', 'if', 'elif', 'else', 'for',
  'while', 'try', 'except', 'finally', 'with', 'pass', 'break', 'continue', 'raise',
  'yield', 'lambda', 'True', 'False', 'None', 'and', 'or', 'not', 'in', 'is', 'del',
  'global', 'nonlocal', 'assert', 'async', 'await', 'print',
)
KW.sh = KW.bash = KW.shell = KW.zsh = kw(
  'if', 'then', 'else', 'elif', 'fi', 'for', 'do', 'done', 'while', 'case', 'esac',
  'function', 'return', 'export', 'local', 'in', 'until', 'select', 'echo', 'exit',
  'source', 'alias', 'unset', 'readonly', 'declare', 'typeset', 'shift', 'true', 'false',
)
KW.rust = kw(
  'fn', 'let', 'mut', 'const', 'struct', 'enum', 'impl', 'trait', 'use', 'mod',
  'pub', 'priv', 'return', 'if', 'else', 'for', 'while', 'loop', 'match', 'in',
  'move', 'ref', 'self', 'Self', 'super', 'crate', 'as', 'where', 'type', 'unsafe',
  'async', 'await', 'dyn', 'box', 'extern', 'static', 'true', 'false', 'break', 'continue',
  'i8', 'i16', 'i32', 'i64', 'i128', 'isize', 'u8', 'u16', 'u32', 'u64', 'u128', 'usize',
  'f32', 'f64', 'bool', 'char', 'str', 'String', 'Vec', 'Option', 'Result',
)
KW.go = kw(
  'func', 'var', 'const', 'type', 'struct', 'interface', 'map', 'chan', 'package',
  'import', 'return', 'if', 'else', 'for', 'range', 'select', 'switch', 'case',
  'default', 'break', 'continue', 'goto', 'fallthrough', 'defer', 'go', 'make',
  'new', 'nil', 'true', 'false', 'len', 'cap', 'append', 'copy', 'delete', 'close', 'error',
  'int', 'int8', 'int16', 'int32', 'int64', 'uint', 'float32', 'float64', 'string', 'bool', 'byte',
)
KW.java = kw(
  'class', 'interface', 'enum', 'extends', 'implements', 'import', 'package',
  'public', 'private', 'protected', 'static', 'final', 'abstract', 'synchronized',
  'volatile', 'transient', 'native', 'new', 'this', 'super', 'return', 'if', 'else',
  'for', 'while', 'do', 'switch', 'case', 'break', 'continue', 'default', 'try', 'catch',
  'finally', 'throw', 'throws', 'void', 'null', 'true', 'false', 'instanceof',
...
KW.cpp = new Set([
  ...
  'private', 'protected', 'new', 'delete', 'this', 'nullptr', 'bool', 'using',
  'inline', 'explicit', 'operator', 'friend', 'constexpr', 'noexcept', 'auto',
  'decltype', 'mutable', 'string', 'vector', 'map', 'set', 'cout', 'cin',
])
KW.ruby = kw(
  'def', 'class', 'module', 'return', 'if', 'elsif', 'else', 'unless', 'for', 'while',
  'do', 'end', 'begin', 'rescue', 'ensure', 'raise', 'yield', 'lambda', 'proc', 'self',
  'nil', 'true', 'false', 'and', 'or', 'not', 'in', 'then', 'case', 'when', 'puts', 'print',
  'require', 'include', 'extend', 'attr_reader', 'attr_writer', 'attr_accessor',
)
KW.php = kw(
  'function', 'class', 'return', 'if', 'elseif', 'else', 'foreach', 'for', 'while', 'do',
  'switch', 'case', 'break', 'continue', 'default', 'try', 'catch', 'finally', 'throw',
  'new', 'null', 'true', 'false', 'echo', 'print', 'const', 'static', 'public',
  'private', 'protected', 'interface', 'extends', 'implements', 'use', 'namespace',
  'require', 'include', 'abstract', 'final',
)
KW.sql = kw(
  'SELECT', 'FROM', 'WHERE', 'JOIN', 'LEFT', 'RIGHT', 'INNER', 'OUTER', 'CROSS', 'FULL',
  'ON', 'AS', 'AND', 'OR', 'NOT', 'IN', 'IS', 'NULL', 'INSERT', 'UPDATE', 'DELETE',
  'CREATE', 'DROP', 'ALTER', 'TABLE', 'INDEX', 'VIEW', 'TRIGGER', 'PROCEDURE', 'FUNCTION',
  'DATABASE', 'SCHEMA', 'GROUP', 'BY', 'ORDER', 'HAVING', 'LIMIT', 'OFFSET', 'UNION',
  'ALL', 'DISTINCT', 'COUNT', 'SUM', 'AVG', 'MAX', 'MIN', 'INTO', 'VALUES', 'SET',
  'PRIMARY', 'KEY', 'FOREIGN', 'REFERENCES', 'UNIQUE', 'DEFAULT', 'WITH', 'CASE',
  'WHEN', 'THEN', 'END', 'ELSE', 'EXISTS', 'BETWEEN', 'LIKE', 'ASC', 'DESC',
  'CONSTRAINT', 'CHECK', 'COMMIT', 'ROLLBACK', 'BEGIN', 'TRANSACTION',
)
...
export function highlight(code: string, lang: string): Token[] {
  ...
  const isHashComment = isPython || langKey === 'sh' || langKey === 'bash' ||
    langKey === 'shell' || langKey === 'zsh' || langKey === 'ruby' || langKey === 'r' ||
    langKey === 'perl' || langKey === 'yaml' || langKey === 'toml' || langKey === 'ini'
  ...
  while (i < n) {
    ...
    if ((isPython || langKey === 'ruby') && (ch === '"' || ch === "'") && code[i + 1] === ch && code[i + 2] === ch) {
